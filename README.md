...
Este repositório contém as soluções desenvolvidas para os desafios práticos da disciplina de FCCPD. O objetivo é demonstrar conhecimentos em containerização, orquestração, microsserviços e arquiteturas distribuídas.
...
### Navegação Rápida dos README.md do projeto
